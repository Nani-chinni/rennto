...
export default function IssuesScreen({ navigation }) {
  const { t } = useLanguage();
  const { tenantStatus } = useContext(BookingContext);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.centerContent}>
        ...
        <Text style={styles.emptyTitle}>
          {isPending 
            ? (t("approval_request") || "Approval Request") 
            : (t("verification_required") || "Verification Required")}
        </Text>

        <Text style={styles.emptySub}>
          {isPending
            ? (t("cannot_report_issues_pending") || "You cannot report maintenance issues yet. Please wait for the owner to accept your residency request.")
            : (t("cannot_report_issues_aadhaar") || "Your request is approved. Please upload your Aadhaar document in the notifications tab to verify your details.")}
        </Text>
        ...
        <View style={styles.statusLabelContainer}>
          ...
          <Text style={styles.statusText}>
            {isPending 
              ? (t("waiting_owner_verification") || "Waiting for Owner's Verification")
              : (t("waiting_aadhaar_upload") || "Waiting for Aadhaar Upload")}
          </Text>
        </View>
