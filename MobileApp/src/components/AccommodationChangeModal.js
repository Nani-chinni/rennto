...
export default function AccommodationChangeModal({
  ...
  const [selectedBed, setSelectedBed] = useState("Choose a room first");
  ...
  useEffect(() => {
    if (visible) {
      ...
      setSelectedBed("Choose a room first");
      setReason("");
            ...
            <View style={styles.container}>
              ...
              >
                ...
                <Text style={{ fontSize: 13, color: "#6B7280", marginBottom: 16, lineHeight: 18 }}>
                  Pick the exact place you want to move to. Your owner approves this allocation directly, so all fields are required.
                </Text>
