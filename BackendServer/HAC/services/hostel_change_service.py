...
class HostelChangeService:
    ...
    def get_pending_requests_for_owner(owner_id):
        ...
        """
        # Accept either an owner_id or a phone number, the same way every
        # other owner endpoint resolves its identifier. Looking up owner_id
        # only meant a caller passing a phone got "Owner not found" -> 500,
        # and the owner silently saw no pending change requests.
