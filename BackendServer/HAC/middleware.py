...
from HAC.jwt_utils import get_jwt_signing_key, get_jwt_algorithm
...
class OwnerAccountMiddleware:
    ...
    def __call__(self, request):
        ...
        if auth_header and auth_header.startswith('Bearer '):
            ...
            try:
                # Decoded with the JWT signing key here only to read the claims;
                # the jwt_required decorator does the authoritative validation.
