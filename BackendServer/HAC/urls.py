...
urlpatterns = [
    ...
    # Accommodation Change Requests
    path('api/accommodation-change/create/', views.create_accommodation_change_request),
    path('api/accommodation-change/tenant/<str:tenant_phone>/', views.get_tenant_accommodation_requests),
    path('api/accommodation-change/owner/<str:owner_id>/', views.get_owner_accommodation_requests),
    path('api/accommodation-change/update/<int:request_id>/', views.update_accommodation_request_status),
