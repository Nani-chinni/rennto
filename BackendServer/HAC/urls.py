...
urlpatterns = [
    ...
    path('api/send-admin-otp/', views.send_admin_otp),
    path('api/verify-admin-otp/', views.verify_admin_otp),
    path('api/admin-password/', views.admin_password_login),
    path('api/check-admin-password-status/', views.check_admin_password_status),
    path('api/admin-forgot-password/', views.forgot_admin_password),
    path('api/admin-login/', views.admin_login),
    path('api/admin_home/', views.admin_home),
    path("api/admin/system-settings/", views.admin_system_settings),
    ...
    path('api/send_request/', views.send_join_request),
    path('api/existing_tenant_request/', views.existing_tenant_request),
    path('api/check_request_status/<str:tenant_phone>/<str:owner_phone>/<str:property_name>/', views.check_request_status),
    path('api/withdraw_request/', views.withdraw_request),
    path('api/owner_requests/<str:phone>/', views.owner_requests),
    path('api/update_request_status/', views.update_request_status),
    path('api/clear_owner_request/<int:request_id>/', views.clear_owner_request),
    ...
    path('api/send-owner-notification/', views.send_owner_notification),
    path('api/send-tenant-notification/', views.send_tenant_notification),
    path('api/notifications/unread-count/', views.get_unread_notification_count),
    path('api/notifications/<str:phone>/', views.get_notifications),
    path('api/notifications/<int:notification_id>/read/', views.mark_notification_read),
    path('api/notifications/<str:phone>/mark-all-read/', views.mark_all_notifications_read),
    path('api/tenant_notifications/<str:identifier>/', views.tenant_notifications),
